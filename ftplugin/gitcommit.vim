...
function! s:gitdiffcached(bang,gitdir,...)
  ...
  " Yuck. System already redirects for you. Calling :silent ! pops up a dos
  " box, unlike system, which runs it minimized
  let diff = system(git." diff --cached --no-color ".extra)
